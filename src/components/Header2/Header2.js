...
import btnbg from '../../images/shapes/btn_mask_bg.png'
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-3 col-5 d-flex align-items-center">
                            <div className="site_logo">
                                <NavLink onClick={ClickHandler} className="site_link" to="/">
                        ...
                        <div className="col-lg-3 col-5">
                            <ul className="btns_group unordered_list p-0 justify-content-end">
                                ...
                                <li>
                                    <NavLink onClick={ClickHandler} className="memecoin_btn bg-light" to="/sign_in">
                                        <span className="btn_icon">
                                            <i className="fa-solid fa-user"></i>
                                        </span>
                                        <span className="btn_label">Login</span>
                                        <span className="btn_bg" style={{ maskImage: `url(${btnbg})` }}></span>
                                    </NavLink>
                                </li>
                            </ul>
                        </div>
