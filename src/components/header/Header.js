                        ...
                        <div className="col-lg-3 col-5">
                            <ul className="btns_group unordered_list p-0 justify-content-end">
                                ...
                                <li>
                                {
                                    ...
                                    <div onClick={handleDisconnect} className="ico_btn_outline" style={{cursor: "pointer"}}>
                                        <span className="btn_icon">
                                            <i className="fa-solid fa-user"></i>
                                        </span>
                                        <span className="btn_label">{walletAddressResize(loggedInInfo?.walletAddress)}</span>
                                    </div>
                                    :
