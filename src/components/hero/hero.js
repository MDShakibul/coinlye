...
import Bg2 from '../../images/shapes/shape_bg_ico_countdown.svg'
...
const Hero = ({connectAndApprove}) => {
    ...
    return (
        <section className="ico_hero_section section_decoration text-center" style={{ backgroundImage: `url(${Bg})` }}>
            <div className="container">
                    ...
                    <li>
                        <button className="ico_creative_btn" onClick={() => connectAndApprove()}>
                            <span className="btn_wrapper">
                                ...
                                <span className="btn_label">Connect</span>
                ...
                <div data-aos="fade-up" data-aos-duration="900" data-aos-delay="200">
                    <div className="ico_countdown_progress_box">
                        ...
                        <div className='countdownbg' style={{ backgroundImage: `url(${Bg2})` }}>
                            <TimeCountDown />
                        </div>
            ...
            <div className="shape_bottom">
                <img src={shape} alt="Bottom Line Shape" />
            </div>
            <div className="decoration_item shape_globe">
                <img src={shape2} alt="Shape Globe" />
            </div>
            <div className="decoration_item shape_coin">
                <img src={shape3} alt="Shape Coin" />
            </div>
        </section>
    )
}
